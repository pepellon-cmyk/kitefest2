"""
Kite For Life - app_Version4_Version4.py
...
def map_columns_to_criterios(df: pd.DataFrame):
    ...
    # 2) Busca correspondência por inclusão (heurística)
    for crit in CRITERIOS:
...
st.sidebar.write("- Coloca este ficheiro (app_Version4_Version4.py) e requirements.txt na raiz do repo antes de fazer deploy.")
